...
```
#install.packages("tidyverse") library(tidyverse) install.packages("nycflights13")
#install.packages("ggstance") install.packages("lvplot") install.packages("ggbeeswarm")
...
merge.geno.bim <- read_delim("/home/m280-data/hw1/merge-geno.bim", 
                             delim = "\t", col_names = FALSE)
merge.geno.fam <- read_delim("/home/m280-data/hw1/merge-geno.fam", delim = " ", 
                             col_names = FALSE)
#rename variables
merge.geno.bim <- merge.geno.bim %>%
  rename(chromosome = X1, snpid = X2, gendist = X3, bp = X4, allelle1 = X5, 
         allelle2 = X6) 

merge.geno.fam <- merge.geno.fam %>%
  rename(famid = X1, personid = X2, fid = X3, mid = X4, sex = X5, affstat = X6)
...
pfile <- write.table(merge.geno.fam1[, c("famid", "person_id_sub", 
              ...
              file = '/home/nanchen322/Biostat-m280-2018-winter/hw2/pfile.txt', 
              sep = ",", na = "NA", row.names = FALSE, quote = FALSE)
```
